var Breakfast = [
    {
        name: 'Breakfast', items: [
            ...
            },
            {
                ...
                description: 'Biscuits, Sausage, and Mozzarella baked in a casserole form. Topped with a Sausage Gravy and Fried Egg',
                additional: '',
                price: '10.00'
            }, {
                name: 'Build an Omelete',
                description: '3 Egg Omelete with Choice of 3 Fillings',
                additional: 'Cheese, Bacon,Sausage, Ham, Chicken, Caramelized Onions, Tomatoes, Peppers, Spinach (each additional +$0.50)',
                price: '9.50'
            }, {
                ...
                description: 'Bacon, Ham, Fried Egg, Cheddar on Sourdough. Choice of 2 sides.',
                additional: '',
                price: '9.00'
            }, {
                name: 'Avocado Toast',
...
var SmallBites = [{
    ...
    {
        name: 'Pizza Bites',
        description: 'Fried Eggrolls stuffed with Mozzarella Cheese and Pepperoni. Served with Marinara Sauce',
        additional: '',
        price: '9.00'
    },
    {
...
var Soups = [{
    name: 'Soup and Salads', items: [{
        name: 'Soup/Stew of the Day ',
        description: 'Cup 3.00 Bowl 5.00',
        additional: '',
        price: ''
    }, {
        name: 'Side Salad',
...
var Lunch = [{
    ...
    {
        name: 'Country Chicken Salad Sandwich',
        description: 'Chicken tossed with Dried Cranberries, Apples, and Celery. Topped with Lettuce and Tomato on a Croissant.',
        additional: '',
        price: '10.25'
    },
    {
        name: 'Chicken and Waffle Sandwich ',
        description: 'Savory Cheddar-Sage Waffles filled with a Spiced Honey Glazed Chicken Cutlet, and Southern Slaw',
        additional: '',
        price: '11.25'
    }, {
...
var lunch2 = [{
    ...
    {
        name: 'Patty Melt',
        description: '1/2lb Beef Patty topped with Caramelized Onions, Swiss Cheese and Thousand Island on toasted Rye Bread',
        additional: '',
        price: '11.25'
    },
    {
        name: 'Classic Cheeseburger',
        description: '1/2lb Beef Patty, Cheddar Cheese, Lettuce, Tomato, Red Onion, Pickles and Thousand Island',
        additional: '',
        price: '11.25'
    },
    {
        name: 'The Cozy Bistro Burger',
        description: '1/2lb Beef Patty, Aged White Cheddar, Brown Sugar Peppered Bacon, Avocado, Lettuce, and a Black Pepper Aioli',
        additional: '',
        price: '12.00'
    }, {
        name: 'Pastrami Burger',
        description: '1/2lb Beef Patty, Hot Pastrami, Swiss, Spicy Mustard, and Southern Slaw',
        additional: '',
        price: '13.50'
    }
...
var KidsBreakfast = [{
    name: 'Breakfast', items: [{
        ...
        description: '2 Pancakes or 1 Waffle (Classic, Blueberry, or Chocolate Chip). Served with Fruit',
        additional: '',
        price: '5.50'
    },
    {
        name: 'Kiddie Mini',
        description: '1 Egg, choice of Sausage or Bacon, 1 Piece of Toast, Fruit. ',
        additional: '',
        price: '6.00'
    },
    {
        name: 'Breakfast “Sundae”',
        description: 'Vanilla Yogurt topped with Granola, Fruit, and Whipped Cream',
        additional: '',
        price: '5.00'
    }
    ]
...
var KidsLunch = [{
    name: 'Lunch', items: [{
        name: 'Mini Corn Dogs',
        description: 'Served with Ketchup and Mustard',
        additional: '',
        price: '6.00'
    },
    {
        name: 'Gooey Grilled Cheese',
        description: 'White Bread with Melted Cheese center',
        additional: '',
        price: '5.00'
    },
    {
        name: 'Lil Burger Sliders',
        description: '2 Cheeseburger Sliders with Lettuce, Ketchup, and Mustard',
        additional: '',
        price: '7.00'
    }
    ]
